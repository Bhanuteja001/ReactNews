      ...
      {loading ? <Loader /> :
          ...
          <div className="container mt-5" style={{ width: "100%", margin: "20px auto" }}>
            ...
            <div className='d-flex justify-content-between'>
                    <button className="btn btn-primary" onClick={()=>setpage(page>1?page-1:page)} disabled={page==1}>&lt;</button>
                    <button className="btn btn-primary" onClick={()=>setpage(page=>page+1)}>&gt;</button>
                </div>
          </div>
